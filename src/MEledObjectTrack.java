...
//		frame4.setSize(webcam_image.width()+40,webcam_image.height()+60);
        ...
        Scalar hsv_min = new Scalar(90, 70, 70, 0);
...
//					Core.bitwise_and(hsv_image,webcam_image,thresholded2,thresholded);

//					Imgproc.cvtColor(thresholded2, thresholded2, Imgproc.COLOR_HSV2BGR);
//thresholded = thresholded2;
...
//                                double c = Math.max(contours[1], Imgproc.contourArea());
//                                        Imgproc.moments()
//                    }
...
//							,1.0,new Scalar(100),3);
                    ...
                    panel1.setimagewithMat(hsv_image);
